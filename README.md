...
1. What is React JS and what problems does it solve? Support your answer with concepts introduced in class and from your personal research on the web.
    // React is an open-source Javascript library created by Facebook in order to streamline the building of user interfaces and components.

1. Describe component state.
    // A component state tells a Javascript component what to render or display by indicating the state of said component.

1. Describe props.
    // Props are variables that are passed between the different parts of a React component that assist in telling the component what to render.

1. What are side effects, and how do you sync effects in a React component to changes of certain state or props?
    // Side effects are anything that affect other parts of the component outside the scope of the function that is being called. To sync effects, you use the effect hook.
